...
async function switchToScene(sceneName) {
  ...
  switch (sceneName) {
    case "whiteboard":
      const { setupThreeScene } = await import("./threeSetup-WDR34MJ2.js");
      setupFunction = setupThreeScene;
      break;
    case "table":
      const { setupTableScene } = await import("./tableSetup-ME2WJWSO.js");
...
//# sourceMappingURL=chunk-U74CR6EB.js.map
