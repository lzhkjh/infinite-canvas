...
async function switchToScene(sceneName) {
  ...
  switch (sceneName) {
    case "whiteboard":
      const { setupThreeScene } = await import("./threeSetup-FNZRYRGV.js");
      setupFunction = setupThreeScene;
      break;
    case "table":
      const { setupTableScene } = await import("./tableSetup-KEV2KRVQ.js");
      setupFunction = setupTableScene;
      break;
    case "simple":
      const { setupSimpleScene } = await import("./simpleScene-CAHG34BD.js");
...
//# sourceMappingURL=chunk-UXGOO7OD.js.map
